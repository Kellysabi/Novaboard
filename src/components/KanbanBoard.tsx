...
const KanbanBoard = () => {
  const [columns, setColumns] = useState<Column[]>([
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          note: 'Note: Integrate with Firebase Cloud Messaging for both platforms.',
          priority: 'High',
          progress: 0,
          comments: 3,
          attachments: 1,
  ...
  return (
    <div className="p-4 md:p-6 w-full flex-1 overflow-x-auto overflow-y-auto custom-scrollbar">
      <motion.div 
        layout
        className="flex gap-5 w-max lg:w-full lg:grid lg:grid-cols-4 items-start pb-4"
      >
        <AnimatePresence mode="popLayout">
          {columns.map((column, index) => (
            <motion.div
              ...
              className="w-[280px] sm:w-[300px] lg:w-auto flex-shrink-0 lg:flex-shrink"
            >
